...
The fetcher is configured to get the data in chunks of 1000 

from the API and pass it along to mappers. (NATS)

The mappers get data from fetcher (NATS), 

do modifications to the data, these include time 

consuming operations, and pass the modified data to saver. (NATS)
